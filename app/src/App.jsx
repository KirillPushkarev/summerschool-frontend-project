            ...
            <Router>
                <div className="App">
                    ...
                    <Switch>
                        ...
                        <Route
                            path="/issues/:id"
                            component={props => <IssueDetails {...props} issueApiService={this.issueApiService} />}
                        />
                        <Route
                            path="/createissue"
                            render={props => (
                                <IssueEditForm {...props} mode={"Create"} issueApiService={this.issueApiService} />
                            )}
                        />
                        <Route
                            path="/updateissue/:id"
                            render={props => (
                                <IssueEditForm {...props} mode={"Update"} issueApiService={this.issueApiService} />
                            )}
                        />
                    </Switch>
                </div>
